...
extension MessagesViewController {
    ...
    func generateFakeMessages(){
        ...
        guard CoreDataManager.shared.createMessage(text: "Wanna buy an iphone 4? It's probably the best one Apple has ever made.", date: Date().addingTimeInterval(-2 * 60), user: user3) != nil else { return }
